            ...
            <section class="flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16">
                ...
                <div class="xl:w-5/12 flex flex-col justify-between">
                    ...
                    <div class="sm:text-center lg:text-left lg:py-12 xl:py-24">
                        ...
                        <h1 class="text-black-800 text-4xl sm:text-5xl md:text-5xl font-bold mb-8 md:mb-12">Secure and transparent vaccine supply chain management.</h1>

                        <div class="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
                            <a href="#" class="inline-block bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Signup</a>

                            <a href="#" class="inline-block bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-indigo-300 text-gray-500 active:text-gray-700 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Verify</a>
                        </div>
                    </div>
